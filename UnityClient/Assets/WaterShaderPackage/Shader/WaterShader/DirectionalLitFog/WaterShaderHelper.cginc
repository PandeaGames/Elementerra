...
////// Vertex function
	Vert2FragPro HandleVertexInput(VertexInputPro vertIn, float4 mainTexConfig, float4 normalTexConfig, float4 uvOffset, float foamScale, float4 _Waves, float _WaveHeight)
	{
		Vert2FragPro output;
	...
	{
		Vert2FragPro output;
		output = HandleVertexInput(vertIn, mainTexConfig, normalTexConfig, uvOffset, foamScale, _Waves, _WaveHeight);
